        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                   <i class="fa fa-graduation-cap"></i> Udo-Core
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="{{ url('/home') }}"><i class="fa {{Auth::guest() ? 'fa-lock':'fa-unlock'}}"></i> Panel</a></li>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        <li><a href="{{ url('/login') }}"><i class="fa fa-key"></i> Ingresar</a></li>
                        <li><a href="{{ url('/register') }}"><i class="fa fa-user-plus"></i> Registrar</a></li>
                    @else
                        <li class="dropdown">
